...
<%
    ...
    if (!showAll) {
        ...
        try {
            ...
            if (!showAll && conn != null) try { conn.close(); } catch (SQLException ex) {}
        }
    }
%>
...
<% if (showAll) { %>
        ...
        <%
                ...
                if (rsAll != null) try { rsAll.close(); } catch (SQLException e) {}
                if (pstmtAll != null) try { pstmtAll.close(); } catch (SQLException e) {}
                ...
                <div class="donate-box">
                    ...
                    <% if (session.getAttribute("userEmail") == null) { %>
                        <div class="login-prompt" style="background: #fff7ed; border: 1px dashed #f97316; padding: 24px; border-radius: 16px; text-align: center;">
                            ...
                            <a href="login.jsp" class="btn-primary">Login to Donate</a>
...
function startPayment(){
    ...
    var options = {
        ...
        "key": "rzp_live_Sa9wJWyUqpcoXs", // 🔴 Replace with your Razorpay Key
